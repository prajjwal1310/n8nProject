  ...
  return (
    <div className="w-full h-screen bg-[#0F172A] flex items-center justify-center">
        <div className="box bg-[#1E293B] w-[95vw] flex flex-col gap-3 rounded-xl px-[5vw] py-[7vh]">
            ...
            <label className="text-[5vw] text-white" id="email">Email</label>
            ...
            <label className="text-[5vw] text-white" id="password">Password</label>
            ...
            <button className="bg-[#3B82F6] py-3 text-[5vw] font-semibold rounded-lg">Sign in</button>

            <p className="text-center text-[#94A3B8] mt-5">Need an account? <Link className="text-[#3B82F6] font-semibold" to="/register">Create one</Link></p>
        </div>
    </div>
  )
}
